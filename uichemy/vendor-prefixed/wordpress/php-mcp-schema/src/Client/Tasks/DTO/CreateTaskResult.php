...
namespace UiChemy\Deps\WP\McpSchema\Client\Tasks\DTO;
...
class CreateTaskResult extends Result
{
     ...
     * @since 2025-11-25
     *
     * @var \UiChemy\Deps\WP\McpSchema\Client\Tasks\DTO\Task
     */
    protected Task $task;

    /**
     * @param \UiChemy\Deps\WP\McpSchema\Client\Tasks\DTO\Task $task @since 2025-11-25
     ...
     *     task: array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Client\Tasks\DTO\Task
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \UiChemy\Deps\WP\McpSchema\Client\Tasks\DTO\Task $task */
    ...
    /**
     * @return \UiChemy\Deps\WP\McpSchema\Client\Tasks\DTO\Task
     */
