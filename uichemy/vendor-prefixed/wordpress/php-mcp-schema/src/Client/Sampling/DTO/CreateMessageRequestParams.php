...
namespace UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO;

use UiChemy\Deps\WP\McpSchema\Client\Tasks\DTO\TaskMetadata;
use UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO\RequestParamsMeta;
use UiChemy\Deps\WP\McpSchema\Common\Tasks\DTO\TaskAugmentedRequestParams;
use UiChemy\Deps\WP\McpSchema\Common\Traits\ValidatesRequiredFields;
use UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool;
...
class CreateMessageRequestParams extends TaskAugmentedRequestParams
{
     ...
     * @since 2025-11-25
     *
     * @var array<\UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\SamplingMessage>
     */
     ...
     * @since 2025-11-25
     *
     * @var \UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\ModelPreferences|null
     */
     ...
     * @since 2025-11-25
     *
     * @var array<\UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool>|null
     */
     ...
     * @since 2025-11-25
     *
     * @var \UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\ToolChoice|null
     */
    protected ?ToolChoice $toolChoice;

    /**
     * @param array<\UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\SamplingMessage> $messages @since 2025-11-25
     * @param float $maxTokens @since 2025-11-25
     * @param \UiChemy\Deps\WP\McpSchema\Client\Tasks\DTO\TaskMetadata|null $task @since 2025-11-25
     * @param \UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO\RequestParamsMeta|null $_meta @since 2025-11-25
     * @param \UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\ModelPreferences|null $modelPreferences @since 2025-11-25
     ...
     * @param array<\UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool>|null $tools @since 2025-11-25
     * @param \UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\ToolChoice|null $toolChoice @since 2025-11-25
     */
     ...
     *
     * @param array{
     *     task?: array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Client\Tasks\DTO\TaskMetadata|null,
     *     _meta?: array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO\RequestParamsMeta|null,
     *     messages: array<array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\SamplingMessage>,
     *     modelPreferences?: array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\ModelPreferences|null,
     ...
     *     tools?: array<array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool>|null,
     *     toolChoice?: array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\ToolChoice|null
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\SamplingMessage> $messages */
        $messages = array_map(
        ...
        /** @var \UiChemy\Deps\WP\McpSchema\Client\Tasks\DTO\TaskMetadata|null $task */
        ...
        /** @var \UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\ModelPreferences|null $modelPreferences */
        ...
        /** @var array<\UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool>|null $tools */
        ...
        /** @var \UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\ToolChoice|null $toolChoice */
    ...
    /**
     * @return array<\UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\SamplingMessage>
     */
    ...
    /**
     * @return \UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\ModelPreferences|null
     */
    ...
    /**
     * @return array<\UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool>|null
     */
    ...
    /**
     * @return \UiChemy\Deps\WP\McpSchema\Client\Sampling\DTO\ToolChoice|null
     */
