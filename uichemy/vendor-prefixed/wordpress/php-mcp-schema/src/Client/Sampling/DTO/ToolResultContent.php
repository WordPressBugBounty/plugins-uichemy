...
use UiChemy\Deps\WP\McpSchema\Common\Protocol\Factory\ContentBlockFactory;
use UiChemy\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface;
use UiChemy\Deps\WP\McpSchema\Common\Protocol\Union\SamplingMessageContentBlockInterface;
...
class ToolResultContent extends AbstractDataTransferObject implements SamplingMessageContentBlockInterface
{
     ...
     * @since 2025-11-25
     *
     * @var array<\UiChemy\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface>
     */
     ...
     * @param array<\UiChemy\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface> $content @since 2025-11-25
     ...
     *     type: 'tool_result',
     *     toolUseId: string,
     *     content: array<array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface>,
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\UiChemy\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface> $content */
        $content = array_map(
    ...
    /**
     * @return array<\UiChemy\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface>
     */
