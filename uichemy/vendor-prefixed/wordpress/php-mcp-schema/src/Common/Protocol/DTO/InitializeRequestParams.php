...
use UiChemy\Deps\WP\McpSchema\Client\Lifecycle\DTO\ClientCapabilities;
...
class InitializeRequestParams extends RequestParams
{
     ...
     * @since 2025-11-25
     *
     * @var \UiChemy\Deps\WP\McpSchema\Client\Lifecycle\DTO\ClientCapabilities
     */
     ...
     * @param \UiChemy\Deps\WP\McpSchema\Client\Lifecycle\DTO\ClientCapabilities $capabilities @since 2025-11-25
     * @param \UiChemy\Deps\WP\McpSchema\Common\Lifecycle\DTO\Implementation $clientInfo @since 2025-11-25
     ...
     *     capabilities: array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Client\Lifecycle\DTO\ClientCapabilities,
     *     clientInfo: array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Common\Lifecycle\DTO\Implementation
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \UiChemy\Deps\WP\McpSchema\Client\Lifecycle\DTO\ClientCapabilities $capabilities */
        $capabilities = is_array($data['capabilities'])
            ? ClientCapabilities::fromArray(self::asArray($data['capabilities']))
            : $data['capabilities'];

        /** @var \UiChemy\Deps\WP\McpSchema\Common\Lifecycle\DTO\Implementation $clientInfo */
    ...
    /**
     * @return \UiChemy\Deps\WP\McpSchema\Client\Lifecycle\DTO\ClientCapabilities
     */
