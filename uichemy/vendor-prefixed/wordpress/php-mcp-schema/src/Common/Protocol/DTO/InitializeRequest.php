...
class InitializeRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeRequestParams
     */
     ...
     * @param \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeRequestParams $params @since 2024-11-05
     */
     ...
     *     id: string|number,
     *     method: 'initialize',
     *     params: array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeRequestParams $params */
    ...
    /**
     * @return \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeRequestParams
     */
