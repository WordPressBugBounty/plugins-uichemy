...
class ProgressNotification extends JSONRPCNotification implements ClientNotificationInterface, ServerNotificationInterface
{
    ...
    /**
     * @var \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\ProgressNotificationParams
     */
    protected ProgressNotificationParams $typedParams;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\ProgressNotificationParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\ProgressNotificationParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\ProgressNotificationParams $params */
    ...
    /**
     * @return \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\ProgressNotificationParams
     */
