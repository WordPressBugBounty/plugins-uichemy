...
namespace UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO;

use UiChemy\Deps\WP\McpSchema\Common\AbstractDataTransferObject;
use UiChemy\Deps\WP\McpSchema\Common\JsonRpc\Union\JSONRPCResponseInterface;
...
class JSONRPCResultResponse extends AbstractDataTransferObject implements JSONRPCResponseInterface
{
     ...
     * @since 2025-11-25
     *
     * @var \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\Result
     */
     ...
     * @param \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\Result $result @since 2025-11-25
     */
     ...
     *     jsonrpc: '2.0',
     *     id: string|number,
     *     result: array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\Result
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\Result $result */
    ...
    /**
     * @return \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\Result
     */
