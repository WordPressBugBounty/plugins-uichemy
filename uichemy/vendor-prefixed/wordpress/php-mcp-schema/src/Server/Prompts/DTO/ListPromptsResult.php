...
class ListPromptsResult extends PaginatedResult implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt>
     */
    protected array $prompts;

    /**
     * @param array<\UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt> $prompts @since 2024-11-05
     ...
     *     prompts: array<array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt> $prompts */
        $prompts = array_map(
    ...
    /**
     * @return array<\UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt>
     */
