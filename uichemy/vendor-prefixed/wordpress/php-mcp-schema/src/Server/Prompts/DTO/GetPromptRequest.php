...
class GetPromptRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptRequestParams
     */
     ...
     * @param \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptRequestParams $params @since 2024-11-05
     */
     ...
     *     id: string|number,
     *     method: 'prompts/get',
     *     params: array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptRequestParams $params */
    ...
    /**
     * @return \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptRequestParams
     */
