...
class GetPromptResult extends Result implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\PromptMessage>
     */
    protected array $messages;

    /**
     * @param array<\UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\PromptMessage> $messages @since 2024-11-05
     ...
     *     messages: array<array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\PromptMessage>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\PromptMessage> $messages */
        $messages = array_map(
    ...
    /**
     * @return array<\UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\PromptMessage>
     */
