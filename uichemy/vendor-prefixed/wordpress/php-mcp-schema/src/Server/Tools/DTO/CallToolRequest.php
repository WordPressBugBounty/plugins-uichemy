...
class CallToolRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\CallToolRequestParams
     */
     ...
     * @param \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\CallToolRequestParams $params @since 2024-11-05
     */
     ...
     *     id: string|number,
     *     method: 'tools/call',
     *     params: array<string, mixed>|\UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\CallToolRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\CallToolRequestParams $params */
    ...
    /**
     * @return \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\CallToolRequestParams
     */
