...
use UiChemy\Deps\WP\MCP\Core\McpServer;
use UiChemy\Deps\WP\MCP\Handlers\Initialize\InitializeHandler;
use UiChemy\Deps\WP\MCP\Handlers\Prompts\PromptsHandler;
use UiChemy\Deps\WP\MCP\Handlers\Resources\ResourcesHandler;
use UiChemy\Deps\WP\MCP\Handlers\System\SystemHandler;
use UiChemy\Deps\WP\MCP\Handlers\Tools\ToolsHandler;
...
class McpTransportContext {
	 ...
	 *
	 * @var \UiChemy\Deps\WP\MCP\Handlers\Initialize\InitializeHandler
	 */
	 ...
	 * The tools handler.
	 *
	 * @var \UiChemy\Deps\WP\MCP\Handlers\Tools\ToolsHandler
	 */
	 ...
	 *
	 * @var \UiChemy\Deps\WP\MCP\Handlers\Resources\ResourcesHandler
	 */
	 ...
	 * The prompts handler.
	 *
	 * @var \UiChemy\Deps\WP\MCP\Handlers\Prompts\PromptsHandler
	 */
	 ...
	 * The system handler.
	 *
	 * @var \UiChemy\Deps\WP\MCP\Handlers\System\SystemHandler
	 */
	 ...
	 *
	 * @param array{
	 *   mcp_server: \UiChemy\Deps\WP\MCP\Core\McpServer,
	 *   initialize_handler: \UiChemy\Deps\WP\MCP\Handlers\Initialize\InitializeHandler,
	 *   tools_handler: \UiChemy\Deps\WP\MCP\Handlers\Tools\ToolsHandler,
	 *   resources_handler: \UiChemy\Deps\WP\MCP\Handlers\Resources\ResourcesHandler,
	 *   prompts_handler: \UiChemy\Deps\WP\MCP\Handlers\Prompts\PromptsHandler,
	 *   system_handler: \UiChemy\Deps\WP\MCP\Handlers\System\SystemHandler,
	 *   observability_handler: \UiChemy\Deps\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface,
	 *   request_router?: \UiChemy\Deps\WP\MCP\Transport\Infrastructure\RequestRouter,
	 *   transport_permission_callback?: callable|null,
	 *   error_handler?: \UiChemy\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface
