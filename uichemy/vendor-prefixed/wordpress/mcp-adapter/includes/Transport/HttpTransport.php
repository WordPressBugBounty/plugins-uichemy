...
namespace UiChemy\Deps\WP\MCP\Transport;

use UiChemy\Deps\WP\MCP\Transport\Contracts\McpRestTransportInterface;
use UiChemy\Deps\WP\MCP\Transport\Infrastructure\HttpRequestContext;
use UiChemy\Deps\WP\MCP\Transport\Infrastructure\HttpRequestHandler;
use UiChemy\Deps\WP\MCP\Transport\Infrastructure\McpTransportContext;
use UiChemy\Deps\WP\MCP\Transport\Infrastructure\McpTransportHelperTrait;
...
class HttpTransport implements McpRestTransportInterface {
	 ...
	 *
	 * @var \UiChemy\Deps\WP\MCP\Transport\Infrastructure\HttpRequestHandler
	 */
	 ...
	 *
	 * @param \UiChemy\Deps\WP\MCP\Transport\Infrastructure\McpTransportContext $transport_context The transport context.
	 */
	...
	public function check_permission( \WP_REST_Request $request ) {
		 ...
		 * @param \UiChemy\Deps\WP\MCP\Transport\Infrastructure\HttpRequestContext $context    The HTTP request context.
		 */
