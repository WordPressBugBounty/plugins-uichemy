 ...
 *
 * @package UiChemy\Deps\WP\MCP\Domain\Utils
 */

declare( strict_types=1 );

namespace UiChemy\Deps\WP\MCP\Domain\Utils;

use UiChemy\Deps\WP\McpSchema\Common\Content\DTO\AudioContent;
use UiChemy\Deps\WP\McpSchema\Common\Content\DTO\ImageContent;
use UiChemy\Deps\WP\McpSchema\Common\Content\DTO\TextContent;
use UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\Annotations;
use UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\BlobResourceContents;
use UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\EmbeddedResource;
...
final class ContentBlockHelper {
	 ...
	 * @param \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\Annotations|null $annotations Optional annotations for the client.
	 * @param array|null $_meta Optional metadata.
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Common\Content\DTO\ImageContent The created ImageContent DTO.
	 */
	 ...
	 * @param array|null $_meta Optional metadata.
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Common\Content\DTO\AudioContent The created AudioContent DTO.
	 */
	 ...
	 * @param array|null $_meta Optional metadata.
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\EmbeddedResource The created EmbeddedResource DTO.
	 */
	 ...
	 * @param array|null $_meta Optional metadata.
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Common\Content\DTO\TextContent The created TextContent DTO.
	 */
	 ...
	 *
	 * @param \UiChemy\Deps\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface[] $blocks Array of content block DTOs.
	 *
