...
namespace UiChemy\Deps\WP\MCP\Domain\Prompts;

use UiChemy\Deps\WP\MCP\Domain\Contracts\McpComponentInterface;
use UiChemy\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface;
use UiChemy\Deps\WP\MCP\Domain\Utils\AbilityArgumentNormalizer;
...
use UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\PromptArgument;
use WP_Error;
...
final class McpPrompt implements McpComponentInterface {
	 ...
	 *
	 * @var \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt
	 */
	 ...
	 *
	 * @var \UiChemy\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface|null
	 */
	 ...
	 *
	 * @param \UiChemy\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface $builder Builder instance.
	 *
	 * @return self|\WP_Error
	 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt
	 */
