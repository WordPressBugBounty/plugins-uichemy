...
namespace UiChemy\Deps\WP\MCP\Domain\Tools;
...
use UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\ToolAnnotations;
use WP_Error;
...
final class McpTool implements McpComponentInterface {
	 ...
	 *
	 * @var \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool
	 */
	 ...
	 *
	 * @param \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool $tool The Tool DTO.
	 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool
	 */
