...
namespace UiChemy\Deps\WP\MCP\Handlers\Prompts;

use UiChemy\Deps\WP\MCP\Core\McpServer;
use UiChemy\Deps\WP\MCP\Handlers\HandlerHelperTrait;
use UiChemy\Deps\WP\MCP\Infrastructure\ErrorHandling\McpErrorFactory;
use UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptResult;
use UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\ListPromptsResult;
use UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt as PromptDto;
use UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\PromptMessage;
...
class PromptsHandler {
	 ...
	 * Constructor.
	 *
	 * @param \UiChemy\Deps\WP\MCP\Core\McpServer $mcp The WordPress MCP instance.
	 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\ListPromptsResult Response with prompts list DTO.
	 */
	public function list_prompts(): ListPromptsResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param array<\UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt> $prompts Array of Prompt DTOs.
		 * @param \UiChemy\Deps\WP\MCP\Core\McpServer                         $server  The MCP server instance.
		 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptResult|\UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse Response with prompt execution results or error.
	 */
	public function get_prompt( array $params, $request_id = 0 ) {
		...
		try {
			 ...
			 * @param \UiChemy\Deps\WP\MCP\Domain\Prompts\McpPrompt   $mcp_prompt  The MCP prompt instance.
			 * @param \UiChemy\Deps\WP\MCP\Core\McpServer             $server      The MCP server instance.
			 */
	 ...
	 * @param \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt      The prompt DTO for description fallback.
	 * @param string                                $prompt_name Prompt name for logging.
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptResult
	 */
	 ...
	 * @param \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt      The prompt DTO.
	 * @param string                                $prompt_name Prompt name for logging.
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\GetPromptResult
	 */
	 ...
	 * @param string $prompt_name Prompt name for logging.
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\PromptMessage
	 */
