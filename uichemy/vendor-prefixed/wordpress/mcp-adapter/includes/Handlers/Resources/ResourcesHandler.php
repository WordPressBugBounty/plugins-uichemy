...
namespace UiChemy\Deps\WP\MCP\Handlers\Resources;
...
use UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\BlobResourceContents;
use UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\TextResourceContents;
use UiChemy\Deps\WP\McpSchema\Server\Resources\DTO\ListResourcesResult;
use UiChemy\Deps\WP\McpSchema\Server\Resources\DTO\ReadResourceResult;
...
class ResourcesHandler {
	 ...
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Resources\DTO\ListResourcesResult Response with resources list.
	 */
	public function list_resources(): ListResourcesResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param array<\UiChemy\Deps\WP\McpSchema\Server\Resources\DTO\Resource> $resources Array of Resource DTOs.
	 ...
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Resources\DTO\ReadResourceResult|\UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse
	 */
	public function read_resource( array $params, $request_id = 0 ) {
		...
		/** @var \UiChemy\Deps\WP\McpSchema\Server\Resources\DTO\Resource $resource */
		...
		try {
			 ...
			 * @param \UiChemy\Deps\WP\MCP\Domain\Resources\McpResource $mcp_resource The MCP resource instance.
			 * @param \UiChemy\Deps\WP\MCP\Core\McpServer               $server       The MCP server instance.
			 */
	 ...
	 * @param string $uri The resource URI.
	 *
	 * @return array<\UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\TextResourceContents|\UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\BlobResourceContents>
	 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\TextResourceContents|\UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\BlobResourceContents
	 */
