...
namespace UiChemy\Deps\WP\MCP\Handlers\Tools;

use UiChemy\Deps\WP\MCP\Core\McpServer;
use UiChemy\Deps\WP\MCP\Domain\Utils\ContentBlockHelper;
...
use UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\CallToolResult;
use UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\ListToolsResult;
...
class ToolsHandler {
	 ...
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\ListToolsResult Response with all tools.
	 */
	 ...
	 * to MCP clients.
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\ListToolsResult Response with tools list.
	 */
	public function list_tools(): ListToolsResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param array<\UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool> $tools  Array of Tool DTOs.
	 ...
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\CallToolResult|\UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse
	 */
	public function call_tool( array $params, $request_id = 0 ) {
		...
		try {
			 ...
			 * @param \UiChemy\Deps\WP\MCP\Domain\Tools\McpTool $mcp_tool  The MCP tool instance.
			 * @param \UiChemy\Deps\WP\MCP\Core\McpServer       $server    The MCP server instance.
			 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\CallToolResult
	 */
