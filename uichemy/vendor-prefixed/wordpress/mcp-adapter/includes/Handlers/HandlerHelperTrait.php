...
namespace UiChemy\Deps\WP\MCP\Handlers;
...
trait HandlerHelperTrait {
	 ...
	 * @param \UiChemy\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface $error_handler The error handler for logging.
	 *
