...
namespace UiChemy\Deps\WP\MCP\Handlers\Initialize;

use UiChemy\Deps\WP\MCP\Core\McpServer;
use UiChemy\Deps\WP\MCP\Core\McpVersionNegotiator;
use UiChemy\Deps\WP\McpSchema\Common\Lifecycle\DTO\Implementation;
use UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeResult;
...
class InitializeHandler {
	 ...
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeResult Response with server capabilities and information.
	 */
	public function handle( string $client_protocol_version ): InitializeResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param \UiChemy\Deps\WP\McpSchema\Common\Protocol\DTO\InitializeResult $result The initialize result DTO.
