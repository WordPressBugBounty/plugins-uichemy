...
namespace UiChemy\Deps\WP\MCP\Infrastructure\ErrorHandling;

use UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO\Error;
use UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse;
use UiChemy\Deps\WP\McpSchema\Common\McpConstants;
...
class McpErrorFactory {
	 ...
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse
	 */
	 ...
	 * @param mixed|null $data Optional additional error data.
	 *
	 * @return \UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO\Error
	 */
	 ...
	 *
	 * @param \UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse|array $error_response The MCP error response (DTO or array).
	 *
	 ...
	 *
	 * @return true|\UiChemy\Deps\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse Returns true if valid, or JSONRPCErrorResponse DTO if invalid.
	 */
