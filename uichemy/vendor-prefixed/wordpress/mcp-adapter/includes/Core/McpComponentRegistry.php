...
namespace UiChemy\Deps\WP\MCP\Core;

use UiChemy\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface;
use UiChemy\Deps\WP\MCP\Domain\Prompts\McpPrompt;
use UiChemy\Deps\WP\MCP\Domain\Resources\McpResource;
use UiChemy\Deps\WP\MCP\Domain\Tools\McpTool;
use UiChemy\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface;
use UiChemy\Deps\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface;
use UiChemy\Deps\WP\MCP\Infrastructure\Observability\FailureReason;
use UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt as PromptDto;
use UiChemy\Deps\WP\McpSchema\Server\Resources\DTO\Resource as ResourceDto;
use UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool as ToolDto;
use WP_Error;
...
class McpComponentRegistry {
	 ...
	 *
	 * @var array<string, \UiChemy\Deps\WP\MCP\Domain\Tools\McpTool>
	 */
	 ...
	 *
	 * @var array<string, \UiChemy\Deps\WP\MCP\Domain\Resources\McpResource>
	 */
	 ...
	 *
	 * @var array<string, \UiChemy\Deps\WP\MCP\Domain\Prompts\McpPrompt>
	 */
	 ...
	 * MCP Server instance.
	 *
	 * @var \UiChemy\Deps\WP\MCP\Core\McpServer
	 */
	 ...
	 *
	 * @var \UiChemy\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface
	 */
	 ...
	 *
	 * @var \UiChemy\Deps\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface
	 */
	 ...
	 * Constructor.
	 *
	 * @param \UiChemy\Deps\WP\MCP\Core\McpServer $mcp_server MCP server instance.
	 * @param \UiChemy\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface $error_handler Error handler instance.
	 * @param \UiChemy\Deps\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface $observability_handler Observability handler instance.
	 */
	public function __construct(
		 ...
		 * @param \UiChemy\Deps\WP\MCP\Core\McpServer $server        The McpServer instance owning the registry.
		 */
	 ...
	 *
	 * @param list<string|\UiChemy\Deps\WP\MCP\Domain\Tools\McpTool> $tools Array of ability names (strings) or McpTool instances.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param string|\UiChemy\Deps\WP\MCP\Domain\Tools\McpTool $tool_item The tool to register.
	 *
	 * @return void
	 */
	private function register_single_tool( $tool_item ): void {
		...
		if ( $tool_item instanceof McpTool ) {
			...
			/** @var \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool $tool_dto */
	 ...
	 *
	 * @param \UiChemy\Deps\WP\MCP\Domain\Tools\McpTool $mcp_tool McpTool instance.
	 *
	 * @return void
	 * @since 0.3.0
	 *
	 ...
	 *
	 * @param list<string|\UiChemy\Deps\WP\MCP\Domain\Resources\McpResource> $resources Array of ability names or McpResource instances.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param string|\UiChemy\Deps\WP\MCP\Domain\Resources\McpResource $resource_item The resource to register.
	 *
	 * @return void
	 */
	private function register_single_resource( $resource_item ): void {
		...
		if ( $resource_item instanceof McpResource ) {
			...
			/** @var \UiChemy\Deps\WP\McpSchema\Server\Resources\DTO\Resource $resource_dto */
	 ...
	 *
	 * @param \UiChemy\Deps\WP\MCP\Domain\Resources\McpResource $mcp_resource McpResource instance.
	 *
	 ...
	 *
	 * @param list<string|\UiChemy\Deps\WP\MCP\Domain\Prompts\McpPrompt|\UiChemy\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface> $prompts Array of prompts to register.
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param string|\UiChemy\Deps\WP\MCP\Domain\Prompts\McpPrompt|\UiChemy\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface $prompt_item The prompt to register.
	 *
	 * @return void
	 */
	private function register_single_prompt( $prompt_item ): void {
		...
		if ( $prompt_item instanceof McpPrompt ) {
			...
			/** @var \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt_dto */
	 ...
	 *
	 * @param \UiChemy\Deps\WP\MCP\Domain\Prompts\McpPrompt $mcp_prompt McpPrompt instance.
	 *
	 * @return void
	 * @since 0.3.0
	 *
	...
	private function add_mcp_prompt( McpPrompt $mcp_prompt ): void {
		/** @var \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt */
	 ...
	 *
	 * @param \UiChemy\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface $builder The builder instance.
	 *
	 * @return void
	 */
	...
	private function register_builder_class( string $class_name ): void {
		try {
			/** @var \UiChemy\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface $builder */
	 ...
	 *
	 * @return array<string, \UiChemy\Deps\WP\McpSchema\Server\Tools\DTO\Tool>
	 */
	 ...
	 *
	 * @return array<string, \UiChemy\Deps\WP\McpSchema\Server\Resources\DTO\Resource>
	 */
	 ...
	 *
	 * @return array<string, \UiChemy\Deps\WP\McpSchema\Server\Prompts\DTO\Prompt>
	 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\MCP\Domain\Tools\McpTool|null
	 * @since 0.3.0
	 *
	 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\MCP\Domain\Resources\McpResource|null
	 * @internal
	 * @since 0.3.0
	 *
	 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\MCP\Domain\Prompts\McpPrompt|null
	 * @internal
	 * @since 0.3.0
	 *
	 */
	 ...
	 * @param string $prompt_name Prompt name.
	 *
	 * @return \UiChemy\Deps\WP\MCP\Domain\Prompts\Contracts\McpPromptBuilderInterface|null
	 */
