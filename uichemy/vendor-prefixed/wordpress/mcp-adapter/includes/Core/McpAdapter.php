 ...
 *
 * @package UiChemy\Deps\WP\MCP\Core
 */
...
use UiChemy\Deps\WP\MCP\Abilities\DiscoverAbilitiesAbility;
use UiChemy\Deps\WP\MCP\Abilities\ExecuteAbilityAbility;
use UiChemy\Deps\WP\MCP\Abilities\GetAbilityInfoAbility;
use UiChemy\Deps\WP\MCP\Cli\McpCommand;
...
use UiChemy\Deps\WP\MCP\Servers\DefaultServerFactory;
use WP_Error;
...
final class McpAdapter {
	 ...
	 * Registry instance
	 *
	 * @var \UiChemy\Deps\WP\MCP\Core\McpAdapter
	 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\MCP\Core\McpAdapter
	 */
	...
	public function init(): void {
		 ...
		 * @since 0.1.0
		 *
		 * @param \UiChemy\Deps\WP\MCP\Core\McpAdapter $adapter The MCP Adapter singleton instance.
		 */
	 ...
	 * @param array<class-string<\UiChemy\Deps\WP\MCP\Transport\Contracts\McpTransportInterface>> $mcp_transports Array of MCP transport class names to initialize.
	 * @param class-string<\UiChemy\Deps\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface>|null $error_handler The error handler class name. If null, NullMcpErrorHandler will be used.
	 * @param class-string<\UiChemy\Deps\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface>|null $observability_handler The observability handler class name. If null, NullMcpObservabilityHandler will be used.
	 ...
	 *
	 * @return \UiChemy\Deps\WP\MCP\Core\McpAdapter|\WP_Error McpAdapter instance on success, WP_Error on failure.
	 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\MCP\Core\McpServer|null
	 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\MCP\Core\McpServer[]
	 */
