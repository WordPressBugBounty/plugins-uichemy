...
namespace UiChemy\Deps\WP\MCP\Cli;

use UiChemy\Deps\WP\MCP\Core\McpServer;
use UiChemy\Deps\WP\MCP\Infrastructure\ErrorHandling\McpErrorFactory;
use UiChemy\Deps\WP\MCP\Transport\Infrastructure\JsonRpcResponseBuilder;
use UiChemy\Deps\WP\MCP\Transport\Infrastructure\RequestRouter;
...
class StdioServerBridge {
	 ...
	 *
	 * @var \UiChemy\Deps\WP\MCP\Transport\Infrastructure\RequestRouter
	 */
	 ...
	 *
	 * @param \UiChemy\Deps\WP\MCP\Core\McpServer $server The MCP server to expose.
	 */
	 ...
	 *
	 * @return \UiChemy\Deps\WP\MCP\Transport\Infrastructure\RequestRouter
	 */
